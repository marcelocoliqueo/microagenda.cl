  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -z-20">
        {/* Single centered glow on mobile */}
        <div className="md:hidden absolute -top-10 left-1/2 -translate-x-1/2 w-[28rem] h-[28rem] rounded-full bg-gradient-to-b from-white via-slate-100 to-transparent blur-3xl opacity-70" />
        {/* Dual glows on md+ */}
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <div className="grid md:grid-cols-2 items-center justify-items-center md:justify-items-start gap-8 md:gap-10">
            {/* Left: copy */}
            ...
            <div className="relative">
              <div className="relative mx-auto md:mx-0 w-full max-w-[580px] h-64 md:h-[360px] [perspective:1000px]">
                {/* main dashboard card */}
                <div
